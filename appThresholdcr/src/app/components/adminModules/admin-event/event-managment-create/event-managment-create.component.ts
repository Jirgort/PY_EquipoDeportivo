...
export class EventManagmentCreateComponent {
  ...
  sports: any = ['a'];
    constructor(public datepipe: DatePipe, private router: Router,private formBuilder: FormBuilder,private eventsService: EventsService,private sportService: SportService) {}
