...
export class EventManagmentReadComponent {
      ...
      coach: any;
      constructor(private eventsService:EventsService, private formBuilder: FormBuilder,public currrentUser: CurrentUserService,){
      ...
      enroll(eventID: any, eventObject: any, action: any) {
        ...
        // Service call to API.
        this.eventsService.enrollEventTest(eventID, this.eventInfo.value).subscribe({
          next: (response: any) => {
